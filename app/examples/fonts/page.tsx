    ...
    <div className="mx-auto max-w-3xl px-4 py-12 md:px-6">
      ...
      <div className="mb-10">
        ...
        <p className="text-muted-foreground">
          <code className="rounded bg-muted px-1 py-0.5 text-sm font-mono">next/font/google</code>로
          Google Fonts를 불러오면 빌드 시 자동으로 자체 호스팅되어 외부 네트워크 요청이 발생하지 않습니다.
        </p>
      </div>
      ...
      <section className="mb-10 space-y-6">
        ...
        <div className="rounded-lg border p-6">
          ...
          <div className={notoSansKr.className}>
            ...
            <p className="mt-2 text-sm text-muted-foreground">{sampleText.latin}</p>
          </div>
        </div>
    ...
    <div className={inter.className}>
      이 영역만 Inter 폰트가 적용됩니다.
        ...
        <div className="mt-4 rounded-lg border border-blue-200 bg-blue-50 p-4 text-sm text-blue-800 dark:border-blue-900 dark:bg-blue-950 dark:text-blue-200">
          <strong>참고:</strong> 가변 폰트(variable font)를 사용하면 weight를 배열로 지정할 필요 없이
          더 나은 성능과 유연성을 얻을 수 있습니다.
        </div>
      </section>
    </div>
  );
